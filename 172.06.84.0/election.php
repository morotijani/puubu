    ...
    if (isset($_POST['addelection'])) {
        if (empty($_POST['election_name']) || empty($_POST['election_name'])) {
            ...
            if($statement->rowCount() > 0) {
                $message = '<div class="alert alert-danger" id="temporary">This Election Name Already Exists</div>';
            } else {
                if ($message == '') {
                    ...
                    <div class="card-body p-4">
                        <div class="row align-items-center">
                            <div class="col-12 col-lg-auto mb-3 mb-lg-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <div class="text-body-secondary">Election</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg">
                                <div class="row gx-3  ">
                                    ...
                                    <div class="col-auto">
                                        <a class="btn btn-dark px-3" href="<?= ADROOT; ?>election">
                                            Refresh
                                        </a>
                                    </div>
