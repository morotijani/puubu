    ...
    <nav class="navbar navbar-expand-xl topnav-base">
      <div class="container-lg">
        ...
        <div class="d-flex ms-auto d-xl-none">
          ...
          <!-- Notifications -->
          <div class=" ">
            <button class="btn btn-link" type="button" data-toggle="modal" data-target="#electionModal">
              Start
            </button>
          </div>
        </div>
      ...
      <div class="container flex-column align-items-stretch">
        <div class="row">
          ...
          <div class="col-auto d-flex">
            ...
            <!-- Notifications -->
            <div class=" ">
              <button class="btn btn-link" type="button" data-toggle="modal" data-target="#electionModal">Start
              </button>
            </div>
          </div>
        </div>
