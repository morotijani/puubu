...
$router->mount('/admin', function() use ($router, $twig) {
    ...
    // Election Management
    $router->get('/elections/view/([a-zA-Z0-9\-]+)', function($id) use ($twig) {
        require_once __DIR__ . '/../app/Controllers/AdminController.php';
        $controller = new \App\Controllers\AdminController($twig);
        $controller->electionView($id);
    });
    ...
    $router->post('/voters/import-ajax', function() use ($twig) {
        require_once __DIR__ . '/../app/Controllers/AdminController.php';
        $controller = new \App\Controllers\AdminController($twig);
        $controller->voterImportAjax();
    });

    $router->post('/voters/send-email/([a-zA-Z0-9\-]+)', function($id) use ($twig) {
        require_once __DIR__ . '/../app/Controllers/AdminController.php';
        $controller = new \App\Controllers\AdminController($twig);
        $controller->sendVoterEmail($id);
    });

    $router->post('/voters/bulk-email', function() use ($twig) {
        require_once __DIR__ . '/../app/Controllers/AdminController.php';
        $controller = new \App\Controllers\AdminController($twig);
        $controller->voterBulkEmail();
    });

    $router->post('/voters/send-sms/([a-zA-Z0-9\-]+)', function($id) use ($twig) {
        require_once __DIR__ . '/../app/Controllers/AdminController.php';
        $controller = new \App\Controllers\AdminController($twig);
        $controller->sendVoterSms($id);
    });

    $router->post('/voters/bulk-sms', function() use ($twig) {
        require_once __DIR__ . '/../app/Controllers/AdminController.php';
        $controller = new \App\Controllers\AdminController($twig);
        $controller->voterBulkSms();
    });
    ...
    $router->get('/voters/export/links/([a-zA-Z0-9\-]+)', function($id) use ($twig) {
        require_once __DIR__ . '/../app/Controllers/AdminController.php';
        $controller = new \App\Controllers\AdminController($twig);
